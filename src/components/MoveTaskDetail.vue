    ...
    return {
      ...
      addMoveTable: {
         columns: [
           ...
           {title: '移库单号',key: 'moveType',width: 180,align: 'center'},
           {title: '任务单号',key: 'taskId',width:200,align: 'center'},
           {title: '原货位号',key: 'origStorageId',width:150,align: 'center'},
           {title: '原货位类型',key: 'origStorageType',width:150,align: 'center'},

           {title: '目标货位号',key: 'targetStorageId',width:150,align: 'center'},
           {title: '目标货位类型',key: 'targetStorageType',width:150,align: 'center'},

           {title: '任务数量',key: 'moveQuantity',width:150,align: 'center'},


           {title: '备注',key: 'remark',width:300,align: 'right'},
                                          ...
                                          return h('div', [
                                              h('Button', {
                                                  ...
                                                  on: {
                                                      click: () => {
                                                        ...
                                                        axios.post(sessionStorage.http+'/move/doSendTask',{loginStatus:this.loginStatus,taskDetail:this.rowInfo})
                                                         .then(res => {
                                              ...
                                              h('Button', {
                                                  ...
                                                  on: {
                                                      click: () => {
                                                        this.rowInfo = params.row;
                                                        axios.post(sessionStorage.http+'/move/doTaskComplete',{loginStatus:this.loginStatus,taskDetail:this.rowInfo})
                                                         .then(res => {
