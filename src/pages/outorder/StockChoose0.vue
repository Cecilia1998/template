      ...
      <tr>
        <td>
          ...
          <span class="outBox">
            ...
            <span class="blackLabel">物料/产品号</span>
            <span class="inputBox">
          ...
          <span class="outBox">
            <span class="blank" style="width:20px;">&nbsp;</span>
            <span class="blackLabel">物料/产品描述</span>
            <span class="inputBox">
          ...
          <span class="outBox">
            <span class="blank" style="width:20px;">&nbsp;</span>
            <span class="blackLabel">是否贴标 <span class="inputBox">
          ...
          <span class="outBox">
            <span class="blank" style="width:20px;">&nbsp;</span>
            <span class="blackLabel">检验批号</span>
            <span class="inputBox">
              <Input v-model="formFilter.godowninId" placeholder="请输入"  class="textInput" />
            </span>
          </span>
          <span class="outBox">
            <span class="blank" style="width:20px;">&nbsp;</span>
            <span class="blackLabel">质量状态 <span class="inputBox">
              <Select v-model="formFilter.navDiv"  clearable @on-clear="customeridClear" filterable remote  :loading="customerLoading"  @on-query-change="changeCustomer">
                  <Option v-for="(option, index) in airlineOptions" :value="option.id" :key="index">{{option.name}}</Option>
              </Select>
            </span>
          ...
          <span class="outBox">
            <span class="blank" style="width:20px;">&nbsp;</span>
            <span class="blackLabel">托盘号</span>
            <span class="inputBox">
              <Input v-model="formFilter.godowninId" placeholder="请输入"  class="textInput" />
            </span>
          </span>
          ...
          <span class="outBox">
            <span class="blank" style="width:20px;">&nbsp;</span>
            <span class="blackLabel">供应商 / 车间</span>
            <span class="inputBox">
              <Input v-model="formFilter.godowninId" placeholder="请输入"  class="textInput" />
            </span>
          </span>
          ...
          <Button shape="circle" @click="completeOutPlan"  type="primary"  style="width:120px;height:28px;padding:0px;border-radius:14px;background-color:#5aa5ff;"  >确&nbsp;&nbsp;定</Button>
      ...
      tableColumns: {
        data:[
         ...
         card: [
                  ...
                  {title: '物料/产品号',key: 'districtid',width:200, align: 'center'},
                  {title: '物料/产品描述', key: 'trayno',width:120,align: 'center'},
                  {title: '库存批号', key: 'trayno',width:90,align: 'center'},
                  {title: '检验批号', key: 'customerid',width:150, align: 'center' },
                  {title: '质量状态', key: 'trayno',width:120,align: 'center'},
                  {title: '库区', key: 'trayno',width:120,align: 'center'},
                  {title: '货位', key: 'trayno',width:120,align: 'center'},
                  ...
                  {title: '包装规格', key: 'trayno',width:120,align: 'center'},
                  {title: '计量单位', key: 'trayno',width:120,align: 'center'},
                  {title: '供应商/车间描述', key: 'itemcode',width:200,align: 'center'},
                  {title: '生产日期', key: 'itemname',width:120,align: 'center'},
                  {title: '是否贴标',key: 'inquantity',width:120,align: 'center'},
                  {title: '标签种类',key: 'inquantity',width:120,align: 'center'},
         ]
