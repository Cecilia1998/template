      ...
      <tr>
        <td>
          <div class="" style="position:relative">
            ...
            <span class="outBox">
              <span class="blank" style="width:20px;">&nbsp;</span>
              <span class="blackLabel">库存批次</span>
              <span class="inputBox">
                <Input v-model="formFilter.godowninId" placeholder="请输入"  class="textInput" />
              </span>
            </span>
            <span class="outBox">
              <span class="blank" style="width:20px;">&nbsp;</span>
              <span class="blackLabel">检验批次</span>
              <span class="inputBox">
                <Input v-model="formFilter.godowninId" placeholder="请输入"  class="textInput" />
              </span>
            </span>
          <span class="outBox">
            <span class="blank" style="width:20px;">&nbsp;</span>
            <span class="blackLabel">质量状态</span>
            <span class="inputBox">
              <Input v-model="formFilter.godowninId" placeholder="请输入"  class="textInput" />
            </span>
          </span>
          <span class="outBox">
            <span class="blank" style="width:20px;">&nbsp;</span>
            <span class="blackLabel">指示数量</span>
            <span class="inputBox">
              <Input v-model="formFilter.godowninId" placeholder="请输入"  class="textInput" />
            </span>
          </span>
          <span class="outBox">
            <span class="blank" style="width:20px;">&nbsp;</span>
            <span class="blackLabel">在库数量</span>
            <span class="inputBox">
              <Input v-model="formFilter.godowninId" placeholder="请输入"  class="textInput" />
            </span>
          </span>
          <span class="outBox">
            <span class="blank" style="width:20px;">&nbsp;</span>
            <span class="blackLabel">欠品数量</span>
            <span class="inputBox">
              <Input v-model="formFilter.godowninId" placeholder="请输入"  class="textInput" />
            </span>
          </span>
      ...
      tableColumns: {
        data:[
         ...
         card: [
                  ...
                  {title: '出库单号', key: 'trayno',width:120,align: 'center'},
                  {title: '相关单据号', key: 'trayno',width:90,align: 'center'},
                  {title: '物料/产品号', key: 'customerid',width:150, align: 'center' },
                  {title: '物料/产品描述', key: 'customerid',width:150, align: 'center' },
                  {title: '库存批次', key: 'customerid',width:150, align: 'center' },
                  {title: '检验批次', key: 'trayno',width:120,align: 'center'},
                  {title: '质量状态', key: 'itemcode',width:200,align: 'center'},
                  {title: '指示数量', key: 'itemcode',width:200,align: 'center'},
                  {title: '在库数量', key: 'trayno',width:120,align: 'center'},
                  {title: '欠品数量', key: 'trayno',width:120,align: 'center'},
