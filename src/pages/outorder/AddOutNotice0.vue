          ...
          <td>
            ...
            <span class="outBox">
              ...
              <span class="blackLabel">单据来源 <span class="inputBox">
                <Select v-model="formFilter.navDiv"  clearable @on-clear="customeridClear" filterable remote  :loading="customerLoading"  @on-query-change="changeCustomer" style="width:160px;">
            ...
            <div class="" style="position:absolute;bottom:15px;right:50px">
              <Button v-show="!couldDelet" type="primary" shape="circle" disabled style="width:120px;height:28px;border-radius:14px;background-color:white;color:#b4b4b4" icon="md-trash">删除选中项</Button>
              <Button v-show="couldDelet"  type="primary" shape="circle" style="width:120px;height:28px;border-radius:14px;background-color:#fe3838;border:0 none;" @click="delete_confirm = true" icon="md-trash">删除选中项</Button>
              <Input v-model="newLine"  class="textInput" style="width:30px;"/>
              <span class="blackLabel">行明细</span>
                <Button shape="circle" @click="resetOutPlan" type="primary"  style="width:120px;height:28px;padding:0px;border-radius:14px;background-color:#5aa5ff;"  >新&nbsp;&nbsp;增</Button>
              <Button shape="circle" @click="completeOutPlan"  type="primary"  style="width:120px;height:28px;padding:0px;border-radius:14px;background-color:#5aa5ff;"  >提&nbsp;&nbsp;交</Button>
      ...
      tableColumns: {//表格数据
        data:[
         ...
         card: [
                  ...
                  {title: '出库通知单分行号',key: 'districtid',width:200, align: 'center'},
                  {title: '工厂',key: 'storageid', width:200,align: 'center'},
                  {title: '库存地点', key: 'trayno',width:120,align: 'center'},
                  {title: '特殊库存标识', key: 'trayno',width:200,align: 'center'},
                  {title: '特殊库存编号', key: 'trayno',width:90,align: 'center'},
                  {title: '特殊库存行项目', key: 'customerid',width:150, align: 'center' },
                  {title: '物料/产品号', key: 'trayno',width:120,align: 'center'},
                  {title: '物料/产品描述', key: 'trayno',width:120,align: 'center'},
                  {title: '库存批号', key: 'trayno',width:120,align: 'center'},
                  {title: '检验批号', key: 'trayno',width:120,align: 'center'},
                  {title: '质量状态', key: 'trayno',width:120,align: 'center'},
                  {title: '数量', key: 'trayno',width:120,align: 'center'},
                  {title: '件数', key: 'trayno',width:120,align: 'center'},
                  {title: '包装规格', key: 'itemcode',width:120,align: 'center'},
                  {title: '计量单位', key: 'itemname',width:120,align: 'center'},
