<template lang="html">
  <div class="noticeDetail">
    <Modal v-model="showOutNoticeDetail" title="出库通知单明细" :mask-closable='false' footer-hide okText="确定" cancel-text='取消' @on-ok="submit" @on-cancel="cancel" :loading="loading" width='90%' style="height:500px;">
        ...
        <tr>
          <td>
            ...
            <div class="" style="position:absolute;bottom:15px;right:50px">
                ...
                <Button shape="circle" @click="resetOutPlan" type="primary"  style="width:120px;height:28px;padding:0px;border-radius:14px;background-color:#5aa5ff;"  >确&nbsp;&nbsp;认</Button>
                <Button shape="circle" @click="completeOutPlan"  type="primary"  style="width:120px;height:28px;padding:0px;border-radius:14px;background-color:#5aa5ff;"  >取消确认</Button>
              <Button shape="circle" @click="completeOutPlan"  type="primary"  style="width:120px;height:28px;padding:0px;border-radius:14px;background-color:#5aa5ff;"  >创建出库单</Button>
...
export default {
  ...
  data () {
    return {
      showOutNoticeDetail:false,//modal显示标记
      ...
      tableColumns: {//表格数据
        data:[
         ...
         card: [
                  ...
                  {title: '出库单号',key: 'districtid',width:200, align: 'center'},
                  ...
                  {title: '出库单状态', key: 'trayno',width:120,align: 'center'},
                  {title: '出库单号',key: 'districtid',width:200, align: 'center'},
                  {title: '单据来源', key: 'trayno',width:90,align: 'center'},
                  {title: '预定出库日期', key: 'customerid',width:150, align: 'center' },
                  {title: '实际出库日期', key: 'customerid',width:150, align: 'center' },
                  ...
                  // {title: '特殊库存编号', key: 'trayno',width:200,align: 'center'},
  ...
  methods:{
    ...
    queryData(){//查询数据
      axios.post(sessionStorage.http+'/getnoticeDetail?loginStatus='+`${sessionStorage.loginStatus}`,this.formFilter)
      .then((res) =>{
        console.log(res)
