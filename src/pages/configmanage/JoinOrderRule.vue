  ...
  <div class="joinOder">
    ...
    <div class="ruleList" width="30%" >
      <table>
        <tr height="40px">
          <td width="10%"></td>
          <td class="blueYaHei18" width="30%">合单规则顺序</td>
          <td width="40%"></td>
        ...
        if(pass){
          if(productRange){
            this.formFilter.productDateRangeDate.forEach((date) =>{
             ...
             let url = sessionStorage.http+"/generateRuleRange?recordType=4&rules="+this.generateRuleList+"&range="+this.dateRange+"&loginStatus="+`${sessionStorage.loginStatus}`
            ...
            let url = sessionStorage.http+"/generateRuleLast?recordType=4&rules="+this.generateRuleList+"&last="+ this.lastDate+"&loginStatus="+`${sessionStorage.loginStatus}`
            this.generateRule(url)
          }else if (applyLast) {
            ...
            let url = sessionStorage.http+"/generateRule?recordType=4&rules="+this.generateRuleList+"&loginStatus="+`${sessionStorage.loginStatus}`
            this.generateRule(url)
          }
        }
      }else{
