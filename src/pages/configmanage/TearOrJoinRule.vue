<template lang="html">
  <div class="tearJoin">
    <Tabs   class="font18" >
        <TabPane  class="font18"  label="拆单规则">
          <div class="chooseRule">
            <table>
              <tr height="40px">
                <!-- <td class="blueYaHei20">拆单规则</td> -->
                <td width="78%"></td>
                <td>
          ...
          <div class="ruleList" width="30%" >
            <table>
              <tr height="40px">
                <td width="10%"></td>
                <td class="blueYaHei18" width="30%">拆单规则顺序</td>
                <td width="40%"></td>
        ...
        if(pass){
          if(productRange){
            this.formFilter.productDateRangeDate.forEach((date) =>{
             ...
             let url = sessionStorage.http+"/generateRuleRange?recordType=3&rules="+this.generateRuleList+"&range="+this.dateRange+"&loginStatus="+`${sessionStorage.loginStatus}`
            ...
            let url = sessionStorage.http+"/generateRuleLast?recordType=3&rules="+this.generateRuleList+"&last="+ this.lastDate+"&loginStatus="+`${sessionStorage.loginStatus}`
            this.generateRule(url)
          }else if (applyLast) {
            ...
            let url = sessionStorage.http+"/generateRule?recordType=3&rules="+this.generateRuleList+"&loginStatus="+`${sessionStorage.loginStatus}`
            this.generateRule(url)
          }
        }
      }else{
